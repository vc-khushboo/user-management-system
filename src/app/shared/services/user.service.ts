...
import { User, Login, EditProfile, AddEditUser, LoginResponse, UserResponse, SuccessResponse } from './../models/user';
...
export class UserService {
  ...
  public addEditUser(data: AddEditUser, flag: string): Observable<SuccessResponse> {
    if (flag) {
